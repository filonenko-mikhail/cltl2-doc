...
should obey \cdf{*print-readably*}.  Any values returned by the \emph{function}
are ignored.
...
The \emph{table} (which defaults to the value of \cdf{*print-pprint-dispatch*}) must be a pprint
...
The initial value of \cdf{*print-pprint-dispatch*} is implementation-dependent.
...
\cdf{*print-pprint-dispatch*} to its initial value.
...
variables \cdf{*print-level*}, \cdf{*print-length*}, \cdf{*print-lines*},
\cdf{*print-circle*}, \cdf{*print-shared*}, and \cdf{*print-escape*}, and can tolerate
