...
The {\it stream} (which defaults to \cdf{*standard-output*}) follows the
...
\cdf{*terminal-io*}).  The {\it kind} argument specifies the style of
...
it were \cdf{*terminal-io*}.  The run-time value of {\it stream-symbol} must
...
{\it stream-symbol} (or \cdf{*standard-output*} if {\it stream-symbol} is
\cdf{nil}, or \cdf{*terminal-io*} if {\it stream-symbol} is \cdf{t}) is bound
...
{\it Stream} (which defaults to \cdf{*standard-output*}) follows the
