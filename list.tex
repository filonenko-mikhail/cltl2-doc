...
This returns the {\it car} of {\it list}, which must be a cons or {\empty};
that is, {\it list} must satisfy the predicate \cd{listp}.
By definition, the {\it car} of {\empty} is {\empty}.
...
This returns the {\it cdr} of {\it list}, which must be a cons or {\empty};
that is, {\it list} must satisfy the predicate \cd{listp}.
By definition, the {\it cdr} of {\empty} is {\empty}.
...
\cd{(append {\it x} '{\empty})} is an idiom once frequently used to copy the
