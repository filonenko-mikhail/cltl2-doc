...
\emph{for-as-subclause\/} ::= \=\emph{for-as-arithmetic\/} {\Mor} \emph{for-as-in-list\/} \\*
\>\hbox to 0pt{\hss\Mor~}\emph{for-as-on-list\/} {\Mor} \emph{for-as-equals-then\/}  \\*
\>\hbox to 0pt{\hss\Mor~}\emph{for-as-across\/} {\Mor} \emph{for-as-hash\/} {\Mor} \emph{for-as-package\/}  \\
\emph{for-as-arithmetic\/} ::= \=\emph{var\/} \Mopt{type-spec} \Mopt{\Mgroup{\cdf{from} {\Mor} \cdf{downfrom} {\Mor} \cdf{upfrom}} expr1} \\*
...
\emph{for-as-hash\/} ::= \=\emph{var\/} \Mopt{type-spec} \cdf{being} \Mgroup{\cdf{each} {\Mor} \cdf{the}} \\*
\>\Mgroup{\cdf{hash-key} {\Mor} \cdf{hash-keys} {\Mor} \cdf{hash-value} {\Mor} \cdf{hash-values}} \\*
\>\Mgroup{\cdf{in} {\Mor} \cdf{of}} \emph{hash-table\/} \\*
\>\Mopt{\cdf{using} \cd{(}\Mgroup{\cdf{hash-value} {\Mor} \cdf{hash-key}} other-var\/\cd{)}}  \\
\emph{for-as-package\/} ::= \=\emph{var\/} \Mopt{type-spec} \cdf{being} \Mgroup{\cdf{each} {\Mor} \cdf{the}} \\*
\>\emph{for-as-package-keyword\/} \\*
\>\Mgroup{\cdf{in} {\Mor} \cdf{of}} \emph{package\/}  \\
\emph{for-as-package-keyword\/} ::= \=\cdf{symbol} {\Mor} \cdf{present-symbol} {\Mor} \cdf{external-symbol} \\*
\>\hbox to 0pt{\hss\Mor~}\cdf{symbols} {\Mor} \cdf{present-symbols} {\Mor} \cdf{external-symbols} 
\end{tabbing}
