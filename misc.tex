...
\cdf{describe} prints, to the stream in the variable \cdf{*standard-output*},
...
The output is sent to the specified {\it stream}, which
 ...
 the {\it stream} may also be \cdf{nil} (meaning \cdf{*standard-output*})
...
\cd{(dribble {\it pathname})} may rebind \cdf{*standard-input*}
