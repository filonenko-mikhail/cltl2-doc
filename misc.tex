...
\cdf{compile-file}, like \cdf{load}, rebinds \cd{*package*} to its current value.  If
...
\item The value of \cd{*package*} when a top-level form in the file is processed
      by \cdf{compile-file} must be the same as the value of \cd{*package*} when the
      ...
      any top-level form in a file that alters the value of \cd{*package*}
          ...
          \cdf{in-package}, then the value of \cd{*package*} at the time \cdf{load} is
          called must be a package with the same name as the package that
          was the value of \cd{*package*} at the time \cdf{compile-file} was called.
