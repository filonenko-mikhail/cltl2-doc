...
Types \cdf{extended-char} and \cdf{base-char} are added.

The type specifier \cdf{real} is added.

Many other type specifiers is added as names of classes (see chapter~\ref{CLOS})
