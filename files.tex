...
as the \emph{file} argument to \cdf{rename-file} has implementation-dependent consequences;
...
as the \emph{file} argument to \cdf{delete-file} has implementation-dependent consequences;
