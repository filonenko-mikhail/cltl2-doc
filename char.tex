...
\cd{SM04}&\cd{*}&{\rm asterisk}&\cd{LJ02}&\cdf{J}&{\rm capital J}&\cd{LJ01}&\cdf{j}&{\rm small j} \\
\cd{SA01}&\cd{+}&{\rm plus sign}&\cd{LK02}&\cdf{K}&{\rm capital K}&\cd{LK01}&\cdf{k}&{\rm small k} \\
...
as a single glyph, such as \cdf{A} or \cd{*} or \cd{=}.
...
\begin{obsolete}
The predicate \cdf{char-equal} is like \cd{char=}, and similarly
