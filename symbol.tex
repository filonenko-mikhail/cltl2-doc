...
Обращение к символу с некоторым именем приводит к символу который равен \cdf{eq}
необходимому символу. Каждый раз когда функция \cdf{read} читает строку имени
символа она находит соотвествующий данной строке символ. FIXME
