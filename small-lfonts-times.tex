...
% five point
 \font\fivrm  = Times  \@ptscale5  % roman
...
% six point
 \font\sixrm  = Times \@ptscale6   % roman
...
% seven point
 \font\sevrm  = Times \@ptscale7   % roman
...
%\font\sevsyb = cmbsy10 \@ptscale7 % bold math symbols
 \font\sevit  = TimesI \@ptscale7  % text italic
...
% eight point
 \font\egtrm  = Times \@ptscale8   % roman
...
%\font\tensyb = cmbsy10  % bold symbols
 \font\tenit  = TimesI   % text italic
% \font\tensl  = cmsl10   % slanted
 \font\tenbf  = TimesB   % extended bold 
%\font\tenbfs = cmbxsl10 % extended bold slanted
 \font\tentt  = \LetterGothicBold at 8.5pt % typewriter
...
%\font\tentts = cmsltt10 % slanted typewriter
 \font\tensf  = ItcEraBoo at 10pt  % sans serif  (ITC Eras Book)
...
% eleven point
 \font\elvrm  = Times    \@halfmag % roman  
...
%\font\elvsyb = cmbsy10  \@halfmag % bold symbols
 \font\elvit  = TimesI   \@halfmag % text italic
 \font\elvsl  = cmsl10   \@halfmag % slanted
 \font\elvbf  = TimesB   \@halfmag % extenvded bold 
%\font\elvbfs = cmbxsl10 \@halfmag % extended bold slanted
\font\elvtt  = \LetterGothicBold at 10pt   \@halfmag % typewriter
...
% twelve point
 \font\twlrm  = Times    \@magscale1 % roman  
...
%\font\twlsyb = cmbsy10  \@magscale1 % bold symbols
 \font\twlit  = TimesI   \@magscale1 % text italic
 \font\twlsl  = cmsl10   \@magscale1 % slanted
 \font\twlbf  = TimesB   \@magscale1 % extended bold 
%\font\twlbfs = cmbxsl10 \@magscale1 % extended bold slanted
\font\twltt  = \LetterGothicBold at 9.5pt % typewriter
...
% fourteen point
 \font\frtnrm  = Times    \@magscale2 % roman  
...
%\font\frtnsl  = cmsl10   \@magscale2 % slanted
 \font\frtnbf  = TimesB   \@magscale2 % extended bold 
...
% seventeen point
 \font\svtnrm  = Times    \@magscale3 % roman  
...
%\font\svtnsl  = cmsl10   \@magscale3 % slanted
 \font\svtnbf  = TimesB   \@magscale3 % extended bold 
...
%\font\svtntts = cmsltt10 \@magscale3 % slanted typewriter
 \font\svtnsf  = ItcEraDem at 18pt    % sans serif (ITS Eras Demibold)
...
% twenty point
 \font\twtyrm  = Times    \@magscale4 % roman  
...
%\font\twtytts = cmsltt10 \@magscale4 % slanted typewriter
 \font\twtysf  = ItcEraDem at 20pt    % sans serif (ITC Eras Demibold)
...
% twenty-five point
 \font\twfvrm  = Times    \@magscale5 % roman  
