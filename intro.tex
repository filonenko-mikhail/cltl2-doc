...
Когда говорится, что функция <<возвращает \emph{false}>> или <<есть \emph{false}>>
в некоторых случаях, это значит, что она возвращает {\false}.
Тогда как, если говорится, что функция <<возвращает \emph{true}>> или <<есть {\it
...
\cd{?} и  \cd{!}) ни для каких целей не используются в стандартном Common Lisp
