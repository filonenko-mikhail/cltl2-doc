...
(sample-special-form {\emptylist} {\it form1} {\it form2})
\end{lisp}
...
В целом, запись \Mstar{\it x} значит, что {\it x} может встречаться ноль и
...
\cd{(sample-macro {\it var} . {\it body})}, означает то, что имя {\it body}
