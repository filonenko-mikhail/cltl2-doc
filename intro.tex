...
Термин <<Лисповый считыватель (читатель лиспового кода)>> относится не к читателю
этой книги, и не к какому-либо человеку, читающему код на Lisp'е, а к
...
В Common Lisp'е некоторые буквы используется в определённых целях. Полное
...
\cd{\#{\Xbackslash}L} определяет букву \cdf{L}; и \cd{\#(a b c)}
