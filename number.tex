...
\begin{lisp}
(<= 0 x 9)~~~~~~~~~~~~~~~~~~~~~~;{\rm true if \cdf{x} is between 0 and 9, inclusive} \\
(< 0.0 x 1.0)~~~~~~~~~~~~~~~~~~~;{\rm true if \cdf{x} is between 0.0 and 1.0, exclusive} \\
(< -1 j (length s))~~~~~~~~~~~~~;{\rm true if \cdf{j} is a valid index for \cdf{s}} \\
(<= 0 j k (- (length s) 1))~~~~~;{\rm true if \cdf{j} and \cdf{k} are each valid} \\
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;~{\rm indices for \cdf{s} and $\hbox{\cdf{j}}\leq\hbox{\cdf{k}}$}
\end{lisp}
...
arguments is not the same as the \cdf{or} of \cd{<} and \cd{>} of those same
...
\cdf{quotient} behaves like \cd{/} except when dividing integers,
