...
\else %
\def\defmac{\@defmacbegin{Macro}}% index not worked for cyrillic
\fi
...
\else %
\def\defspec{\@defmacbegin{Special form}}% index not worked for cyrillic
\fi
...
\else %
\def\defloop{\@defmacbegin{Loop clause}}% index not worked for cyrillic
\fi
