...
\newenvironment{lisp}{\stepcounter{lispcounter}\begin{tabbing}}{\end{tabbing}\paragraph{}}
...
\def\@defundone\par{\end{defunheader}\endgroup\paragraph{}}

\newenvironment{defmacheader}{\begin{tabbing}}{\end{tabbing}}
...
\global\def\@defmacstart#1{\relax%
  ...
  \expandafter\def\@carret{\expandafter\@ifnextchar\@carret{\@finishdefmac
      \@gobblecr
    }
    {\@tabcr* ~~
      %\end{defmacheader}\begin{defmacheader}
