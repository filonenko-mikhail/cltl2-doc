...
\def\implementation{\paragraph\small\noindent\textbf{Implementation note:}}
\def\endimplementation{\paragraph}
\def\rationale{\paragraph\small\noindent\textbf{Rationale:}}
\def\endrationale{\paragraph}
\def\sideremark{\paragraph\small\noindent\textbf{Remark:}}
\def\endsideremark{\paragraph}
\def\incompatibility{\paragraph\small\noindent\textbf{Compatibility note:}}
\def\endincompatibility{\paragraph}
