...
\item[\cd{(:report \emph{exp})}]
     ...
     \cdf{function} special form. The expression \cd{(function~\emph{exp})} will be evaluated
...
\item[\cd{:test \emph{fn}}]
    ...
    The \emph{fn} must be a suitable argument for the \cdf{function} special form. The
