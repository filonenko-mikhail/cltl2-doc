...
именем \cd{\emph{name}-p}, определяет функцию конструктора с именем
...
Для структуры с именем \cdf{foo}, функция конструктора обычно называется
\cdf{make-foo}.
Вы можете указать другое имя, передав его в качестве аргумента для опции
\cd{:constructor}, или, если вы вообще не хотите обычную функцию
...
конструктора принимает все аргументы как \cd{\&key} параметры. Например,
